...
import { Addcatagory, ImgInputContainerCatagory,Buttongroup } from "./AddCatagoryEliment";
...
const AddCatagory = ({ setOpenCart }) => {
  ...
  return (
    ...
    >
      <ImgInputContainerCatagory style={{border:"1px solid gray",padding:"10px",borderRadius:"5px"}}>
        <IconButton
          color="primary"
